          ...
          <div className="px-2 py-2">
            ...
            {mobileServicesOpen && (
              <div className="ml-12 border-l-2 border-primary/20 pl-3 space-y-0.5 mb-1">
                ...
                <a href="https://nxcar.in/pdi" onClick={() => setIsOpen(false)} data-testid="link-mobile-pdi-services" className="block text-sm text-muted-foreground hover:text-primary py-2.5 px-2 rounded-md hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                  PDI Services
                </a>
