...
import { AdCarCard, SkeletonGrid } from "./dashboard-car-card";
...
export function MyAdsGrid({
  ...
  adsLoading: boolean;
  adListings: any[];
  adsLazy: { visibleItems: any[]; hasMore: boolean; loadMore: () => void; loadingMore: boolean };
}) {
  if (adsLoading) return <SkeletonGrid />;
