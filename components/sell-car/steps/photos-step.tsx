...
type Props = Pick<SellStepsProps, "uploadedImages" | "handleImageUpload" | "removeImage" | "isUploading">;

export function PhotosStep({ uploadedImages, handleImageUpload, removeImage, isUploading }: Props) {
  return (
