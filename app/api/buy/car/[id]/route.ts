    ...
    const result = await cachedFetch(`buy_car_detail_${vehicleId}`, 300, async () => {
      ...
      return {
        ...
        rawData: {
          ...
          rto_number: car.rto_number || "",
          seats: car.seats || "",
          is_active: car.is_active || "",
          vehicle_status: car.vehicle_status || "",
          created_by: car.created_by || "",
          status: car.status || "",
          seller_lower_price: car.seller_lower_price || "",
          seller_upper_price: car.seller_upper_price || "",
          buyer_lower_price: car.buyer_lower_price || "",
          buyer_upper_price: car.buyer_upper_price || "",
          inspection_done: car.inspection_done || 0,
        },
      };
    });
