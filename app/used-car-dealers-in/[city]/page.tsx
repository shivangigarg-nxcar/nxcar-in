      ...
      <main className="pt-16 pb-16">
        <section className="relative py-12 overflow-hidden">
          ...
          <div className="container px-4 max-w-7xl mx-auto relative z-10">
            <Link href="/used-car-dealers-in" className="inline-flex items-center gap-2 text-primary hover:text-primary/80 mb-6 transition-colors" data-testid="link-back-dealers">
