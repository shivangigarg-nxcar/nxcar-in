...
export default function OtpSubmitted() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0E14] flex flex-col" data-testid="otp-submitted-page">
      <Navbar />
      <div className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="max-w-md w-full text-center">
          <CheckCircle className="w-20 h-20 text-green-500 mx-auto mb-6" data-testid="icon-success" />
          <h1 className="text-4xl font-bold text-white mb-3" data-testid="text-success-heading">
            Login Successful!
          </h1>
          <p className="text-slate-400 text-lg mb-8" data-testid="text-success-subtitle">
