...
export default function CityFilter() {
  return (
    <div className="min-h-screen bg-[#0A0E14] flex items-center justify-center" data-testid="city-filter-redirect">
      <div className="w-full max-w-7xl mx-auto px-4">
        <div className="flex gap-4 overflow-hidden">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="flex-shrink-0 w-[280px] rounded-xl overflow-hidden border border-white/5 bg-slate-900/50">
